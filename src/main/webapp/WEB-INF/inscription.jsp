            ...
            <h3> Mon profil :</h3>
                <section>
                    <form action="${pageContext.request.contextPath}/ServletInscription" method="POST">
                        ...
                        <input type="first_name" id="firstName" name="firstName" placeholder="John" required title="Saisissez votre prénom (3 caractères min.)">
                        ...
                        <input type="telephone" id="telephone" name="telephone"  pattern="[0-9]{10}" title="Saissisez votre Téléphone">
                        ...
                        <input type="zip" id="codePostal" name="codePostal" required pattern="[0-9]{5}" title="Saissisez votre code postal">
